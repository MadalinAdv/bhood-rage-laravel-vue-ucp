function getUrlParams(e) {
    var t, n, c = window.location.search.substring(1).split("&");
    for (n = 0; n < c.length; n++)
        if ((t = c[n].split("="))[0] === e) return void 0 === t[1] || decodeURIComponent(t[1])
}! function(e) {
    var t = function() {
        e(window).width();
        return {
            init: function() {
                var t;
                e("#checkAll").change(function() {
                        e("td input:checkbox").prop("checked", e(this).prop("checked"))
                    ...
                    function() {
                        ...
                        "mini" === e("body").attr("data-sidebar-style") && (console.log(e(this).find("ul")), e(this).find("ul").stop())
                    }), t = window.outerHeight, ((t = window.outerHeight) > 0 ? t : screen.height) && e(".content-body").css("min-height", t + 60 + "px"), e('a[data-action="collapse"]').on("click", function(t) {
                    ...
                    function() {
                        ...
                        var n = e("input[name='" + fieldName + "']"),
                            c = parseInt(n.val());
                        isNaN(c) ? n.val(0) : "minus" == type ? n.val(c - 1) : "plus" == type && n.val(c + 1)
    ...
    jQuery(document).ready(function() {
        ...
        e("#preloader").fadeOut(500), e("#main-wrapper").addClass("show"), e("select").selectpicker(), t.load()
